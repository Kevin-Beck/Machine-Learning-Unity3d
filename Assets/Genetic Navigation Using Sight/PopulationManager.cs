...
public class PopulationManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            Vector3 startingPos = new Vector3(transform.position.x + Random.Range(-4, 4), transform.position.y, transform.position.z + Random.Range(-4, 4));
    ...
    void BreedNewPopulation()
    {
        List<GameObject> sortedList = population.OrderBy(o => 
                                (o.GetComponent<Brain>().timeWalking + o.GetComponent<Brain>().timeAlive)
                                                                ).ToList();
        population.Clear();
